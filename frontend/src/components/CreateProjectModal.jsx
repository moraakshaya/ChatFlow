...
const CreateProjectModal = ({ isOpen, onClose }) => {
    const { user } = useAuth();
    const { refreshHierarchy } = useWorkspace();
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                required
                                placeholder="e.g. ChatPlatform V2"
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-900 mb-1">
                                Project Code <span className="text-gray-400 font-normal">(3-5 letters)</span>
                            </label>
                            <input
                                type="text"
                                required
                                maxLength={5}
                                placeholder="e.g. CPLAT"
